...
function makeCloud(tags, minCount, minSize, max, delim, shuffle) {
    ...
    var cloud = document.createElement("ul");
    var link = null;
    var taglinks = [];
    ...
    for (var i in taglinks) {
		...
		listItem.appendChild(taglinks[i]);
		
        cloud.appendChild(listItem);
